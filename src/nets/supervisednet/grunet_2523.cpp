...
thread_local torch::Tensor GruNet_2523::state;
thread_local bool GruNet_2523::resetState = false;

GruNet_2523::GruNet_2523():
...
Tensor GruNet_2523::inputPreprocess(Tensor input) {
	return input.div(4);
}

void GruNet_2523::loadParams(const string modelPath) {
...
const string GruNet_2523::GetName() {
	return "GRUStep";
}
